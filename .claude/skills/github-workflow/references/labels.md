...
Label definitions (names, descriptions, colors) are maintained by `docs/specs/workflow/script-label-setup.md`. This file documents the rules for label usage.
...
When changing a label within a mutually exclusive category, remove the old label and add the new one in a single command:
